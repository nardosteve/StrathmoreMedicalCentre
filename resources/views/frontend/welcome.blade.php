...
<body data-spy="scroll" data-target=".fixed-top">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p class="p-large">Join the medical centre family today!</p>
                ...
                <div class="swiper-container image-slider-1">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide" >
                            <img class="img-fluid" src="frontend/images/details-slide-1.jpg" alt="alternative">
                        </div>
                        <!-- end of slide -->

                        <!-- Slide -->
                        <div class="swiper-slide">
                            <img class="img-fluid" src="frontend/images/details-slide-2.jpg" alt="alternative">
                        </div>
                        <!-- end of slide -->

                        <!-- Slide -->
                        <div class="swiper-slide">
                            <img class="img-fluid" src="frontend/images/details-slide-3.jpg" alt="alternative">
                        </div>
                        <!-- end of slide -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <p>It's easy to register for the course, just fill out the form and click submit. Then you will be registered!</p>
    ...
    <div id="instructor" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid" src="frontend/images/instructor.jpg" alt="alternative">
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
                        <h2>Hey there!, we are SpaceSurvivors</h2>
                        <p>Hey again, this is a cloud computing mini-project that is designed to simulate how the Strathmore Medical Centre can leverage on cloud-computing</p>
                        <p>AWS Cloud is our choice for this case study!</p>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div id="description" class="basic-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>What Will we Develop during this mini-project?</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-6">
                    <ul class="list-unstyled li-space-lg first">
                        <li class="media">
                            ...
                            <div class="media-body">
                                <h4>A basic website to display data</h4>
                                <p>Have a website to mimic the actual strathmore medical centre webite</p>
                            </div>
                        </li>
                        <li class="media">
                            <i class="bullet">2</i>
                            <div class="media-body">
                                <h4>Use of Amazon Web Service (AWS)</h4>
                                <p>In this project we will use Amazon Simple Storage Service (S3) to store patient - user data files</p>
                            </div>
                        </li>
                        <li class="media">
                            <i class="bullet">3</i>
                            <div class="media-body">
                                <h4>Uploading of data.</h4>
                                <p>This project will feature uploading of patient data to the cloud and retreiving the data</p>
                            </div>
                        </li>
                    </ul>
                </div> <!-- end of col -->
                    ...
                    <ul class="list-unstyled li-space-lg second">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>The project will feature: Signup, Signin, Logout and secure URI's</p>
                            </div>
                        </li>
                        <li class="media">
                            <i class="bullet">5</i>
                            <div class="media-body">
                                <h4>A bit of CRUD</h4>
                                <p>In this section one can: Create, Read, Update, Delete. This will allow the admin/user to add data to the site 
                                    that will be used to simulate data.
                                </p>
                            </div>
                        </li>
                        <li class="media">
                            <i class="bullet">6</i>
                            <div class="media-body">
                                <h4>More features to come in the future :-)</h4>
                                <p>In Beta Testing</p>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="basic-3">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="frontend/images/students.jpg" alt="alternative">
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    </div> <!-- end of basic-3 -->
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="image-container">
                        <img class="img-fluid" src="frontend/images/details-lightbox.jpg" alt="alternative">
    ...
    <div id="date" class="basic-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        <h2>We would love to have you here at SUMC</h2>
                        <p>Our mission is to help people do better. The team is excited to invite you to the next Medical Training Course session which undoubtedly will provide you with the necessary skills to improve your online presence. Fill out the form to register and we'll contact you in less than 24h</p>
